        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="tag_form" action="{{route('user.store')}}" method="POST">
                        @csrf
                        <div class="form-group row">
                            <label for="" class="col-sm-1 col-md-2 text-right control-label col-form-label">Name</label>
                            <div class="col-sm-6">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter your fullname" value="{{old('name')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-1 col-md-2 text-right control-label col-form-label">Email</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="email" name="email" placeholder="Your Email id" value="{{old('email')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="password" class="form-control" id="cfpassword" name="cfpassword" placeholder="Same password as above">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-1 col-md-2 text-right control-label col-form-label">Mobile No</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Mobile" value="{{old('phone')}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <div class="row">
                                    ...
                                    <input type="checkbox" class="custom-control-input" id="customControlAutosizing1 " name="status" value="1"> <label class="custom-control-label" for="customControlAutosizing1 ">Status</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <div class="row">
                                    ...
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="customControlAutosizing1 {{$role->id}}" name="role[]" value="{{$role->id}}"> <label class="custom-control-label" for="customControlAutosizing1 {{$role->id}}">{{$role->name}}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
